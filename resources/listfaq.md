...
Our email list is hosted on [Groups.io](https://flgbtqc.groups.io/g/porch). See [Outreach and Resources](/resources#listserv) for how to join.
 ...
 New members must be approved by the [list managers](mailto:{{layout.email_list_owners.email}}) rather than joining automatically. As part of joining on Groups.io, you'll be asked to make your group profile visible to other members, so unlike the list's earlier incarnation, fellow members can see who else is on the list.
 ...
 No email commands needed &mdash; Groups.io manages this for you on the web. Sign in at [flgbtqc.groups.io](https://flgbtqc.groups.io/g/porch) and go to your subscription settings to switch to no email, individual emails, or a daily digest, or to leave the group entirely, any time you like. If you need help, contact the [list managers](mailto:{{layout.email_list_owners.email}}).

 11. What do I do if I'm having problems sending or receiving messages?
 Send a private message to the [list managers](mailto:{{layout.email_list_owners.email}}). They'll do as much as they can to help resolve the problem. Be prepared to say what email program you're using, who your service provider is, and what specific error messages you are getting.

 12. Sometimes when I send a message I get an error message back. Should I be concerned?
 Always forward a copy of any error messages to the [list managers](mailto:{{layout.email_list_owners.email}}). Usually it's because someone's address is no longer working, or has temporarily quit working. They will follow up those errors and attempt to contact the person to find out what is going on. If you yourself are unable to send a message, make sure you are sending your message from the same address with which you are subscribed, otherwise your message will be rejected for security reasons. You can _only_ send email to the list from the address you subscribed with. If you change your email address, you will need to update it in your Groups.io account, or tell the [list managers](mailto:{{layout.email_list_owners.email}}).

 13. Is this a moderated or an unmoderated email list?
 This is an unmoderated list: all messages are sent out to everyone as soon as they are received. The list managers make no decisions about how the list operates without first seasoning things with the clerks of FLGBTQC, and usually brought to Meetings for Business at gatherings. Please do not send comments about how the list is run to the email list. If you have concerns, send them to the clerks and the list managers so they can be brought to Meeting for Business to be discussed with everyone there. This is not a public email list. It is an extension of gatherings and any changes in the way it operates should be made at gatherings.

 14. Any other questions?
 Send comments, concerns, and any other questions to the [list managers](mailto:{{layout.email_list_owners.email}}).
